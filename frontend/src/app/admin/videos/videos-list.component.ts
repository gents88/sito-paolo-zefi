...
@Component({
  ...
  template: `
    <div>
      <div class="toolbar">
        <button mat-flat-button color="primary" routerLink="/admin/videos/new">{{ 'admin.videos.new' | translate }}</button>
      </div>
      <table mat-table [dataSource]="videos()">
        ...
        <ng-container matColumnDef="actions">
          ...
          <td mat-cell *matCellDef="let el">
            <button mat-button [routerLink]="['/admin/videos', el.id, 'edit']">{{ 'common.edit' | translate }}</button>
          </td>
        </ng-container>
